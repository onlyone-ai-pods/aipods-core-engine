...
* **[`VERSION`](file:///home/martin/server/onlyone%20ai%20pods/VERSION):** Versión actual de la documentación (`2.5.0`).
...
* **[`specs/`](file:///home/martin/server/onlyone%20ai%20pods/specs/README.md):** Suite de especificaciones SDD (Smart Router, RAG, Multi-Tenant, Caché, Arquitectura de Plugins, Gobernanza de Releases, Parámetros Empresariales AuthN/AuthZ/DRP/FinOps, Código Limpio & Security Linters, Scaffold & Skills de Plugins, Skills de IA para el Equipo Interno Core, Red-Teaming & Marketplace, Landing Pública, Sandbox Interactivo, Justificaciones & Límites, Protocolo Mandatorio Dry-Run, Gobernanza Adaptativa de Políticas, Marco ISO 9001 & SOC 2, **Sistema de Mejora Continua por Feedback de Usuarios & RLHF Loop**, Pods AFIP/EvoCRM/Social/SCM y OpenAPI contract).
