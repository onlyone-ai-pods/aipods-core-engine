...
* **[`VERSION`](file:///home/martin/server/onlyone%20ai%20pods/VERSION):** Versión actual de la documentación (`3.0.0`).
...
* **[`specs/`](file:///home/martin/server/onlyone%20ai%20pods/specs/README.md):** Suite Completa de 18 Especificaciones SDD (Smart Router, RAG, Multi-Tenant, Caché, Plugins, Releases, Parámetros Empresariales, Código Limpio & Security Linters, Skills de IA Internas/Externas, Red-Teaming & Marketplace, Landing & Sandbox, Justificaciones & Límites, Protocolo Dry-Run, Gobernanza Adaptativa de Políticas, Marco ISO 9001/SOC2/27001, Mejora Continua, **Estrategia de Rebanadas Verticales (Vertical Slicing) & Roadmap Incremental 3.0.0**, Pods AFIP/EvoCRM/Social/SCM y OpenAPI contract).
