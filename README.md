...
* **[`VERSION`](file:///home/martin/server/onlyone%20ai%20pods/VERSION):** Versión actual de la documentación (`1.9.0`).
...
* **[`specs/`](file:///home/martin/server/onlyone%20ai%20pods/specs/README.md):** Suite de especificaciones SDD (Smart Router, RAG, Multi-Tenant, Caché, Arquitectura de Plugins, Gobernanza de Releases, Parámetros Empresariales AuthN/AuthZ/DRP/FinOps, Código Limpio & Security Linters, Scaffold & Skills de Plugins, Skills de IA para el Equipo Interno Core, **Red-Teaming, Monetización SaaS & Marketplace de AI Pods**, Pods AFIP/EvoCRM/Social/SCM y OpenAPI contract).
