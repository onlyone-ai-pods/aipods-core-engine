...
* **[`VERSION`](file:///home/martin/server/onlyone%20ai%20pods/VERSION):** Versión actual de la documentación (`3.2.0`).
...
* **[`specs/`](file:///home/martin/server/onlyone%20ai%20pods/specs/README.md):** Suite Completa de 20 Especificaciones SDD (Smart Router, RAG, Multi-Tenant, Caché, Plugins, Releases, Parámetros Empresariales, Código Limpio & Security Linters, Skills de IA Internas/Externas, Red-Teaming & Marketplace, Landing & Sandbox, Justificaciones & Límites, Protocolo Dry-Run, Gobernanza Adaptativa de Políticas, Marco ISO 9001/SOC2/27001, Mejora Continua, Rebanadas Verticales, GitHub CLI `gh`, **Automatización de Tests BDD Nativos en Go con `godog` & Módulo Traductor User Story a BDD**, Pods AFIP/EvoCRM/Social/SCM y OpenAPI contract).
