...
* **[`VERSION`](file:///home/martin/server/onlyone%20ai%20pods/VERSION):** Versión actual de la plataforma (`5.2.0`).
...
* **[`docs/SDD.md`](file:///home/martin/server/onlyone%20ai%20pods/docs/SDD.md):** Documento de Diseño de Software Enterprise.
* **[`docs/DEVELOPMENT_ONBOARDING_CHECKLIST.md`](file:///home/martin/server/onlyone%20ai%20pods/docs/DEVELOPMENT_ONBOARDING_CHECKLIST.md):** Guía Completa de Onboarding para Desarrolladores y Rutas de los 4 Repositorios en el Workspace (`/home/martin/server/`).
...
1. **`aipods-docs`** (`/home/martin/server/onlyone ai pods`): Documentación, Specs SDD y OpenAPI.
