...
3. **Restricciones de Seguridad e Invariantes:** Reglas estrictas (ej. no filtración entre tenants, umbrales de caché, citas obligatorias RAG).
...
| Épica | Historia de Usuario | Archivo de Especificación (Spec) |
| :--- | :--- | :--- |
...
| **Épica 4** | HU 4.1, HU 4.2, HU 4.3 | [`specs/pods/04_scm_logistics_spec.md`](file:///home/martin/server/onlyone%20ai%20pods/specs/specs/pods/04_scm_logistics_spec.md) |
...
## 🧪 Ejecución de Pruebas Basadas en Especificaciones

Las pruebas automatizadas del proyecto (Pytest / Behave / E2E) deberán cargar estas especificaciones como fuente primaria de aserciones. Ningún cambio en el código o en los prompts del sistema debe integrarse si viola los contratos BDD y Schemas definidos en este directorio.
